# Netflix-Dataset-Latest-2021-Analysis
Data Analysis and Visualization of the 2021 Netflix Titles Dataset using Python (Pandas, NumPy, Matplotlib, Seaborn).


# 🎬 Netflix Data Analysis 2021

## 👩‍💻 Project by:
- **Priya Pal (2022-B-15082003)**
- **Prachi Jadhav (2022-B-24072004A)**
- **Hasti Kansagara (2022-B-26122005)**
...
1. **Distribution of IMDb Scores** – Histogram  
2. **Movies vs Series Count** – Bar Chart  
3. **Netflix Releases Over the Years** – Line & Bar Charts  
4. **IMDb Score vs Box Office** – Scatter Plot  
5. **IMDb Score vs Awards Received** – Regression Plot  
6. **Top Genres by IMDb Score** – Bar Plot  
